...
function Cart() {
  ...
  if (!cart || cart.length === 0) {
    return (
      <div className="bg-white text-black flex justify-center h-full p-4">
        <img src={emptyCart} alt="empty-cart" className="w-2/5" />
      </div>
    );
  }
  ...
  return (
    <div className="bg-white max-h-screen text-black mx-auto mt-2 border border-gray-200 p-4 md:w-2/3 rounded-lg shadow-md sm:p-6 lg:p-8">
